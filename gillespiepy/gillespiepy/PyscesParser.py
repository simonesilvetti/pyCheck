from gillespiepy.gillespiepy import Reaction
...
from gillespiepy.gillespiepy.Constants import UNITS_DICTIONARY
from gillespiepy.gillespiepy import ReactionSystem
...
class PyscesParser:
    ...
    def __init__(self):
        self.reactions = OrderedDict()  # type: OrderedDict[str, Reaction.Reaction]
    ...
    def p_reaction_line(self, t):
        ...
        reaction = Reaction.Reaction(reaction_name, compressed_inputs, compressed_outputs, None, rate_equation)
        self.reactions[reaction_name] = reaction
...
def parse(model_file: str, model_dir: str) -> ReactionSystem.ReactionSystem:
    ...
    lexer.input(model)
    parser = yacc.yacc(module=parser_model)
    ...
    system = ReactionSystem.ReactionSystem(parser_model.parameters, parser_model.reactions)
