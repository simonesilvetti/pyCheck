...
bufo = '(F_[0.39, 1.40](FP <= 215))'
text = '(G_[0.06233027331529984, 1.060596237416429] ((FP >= 1333) | (F <= 7663))'
...
C5 = '(G_[0.12334207667989314, 0.4161316254727053](G_[0.396410271557457, 0.7596368299252299] ((FP >=610) | (F <= 7867))))'  # 210 sec (0.1701388888888889, 0.8472222222222222, 0.1875)
0.35397927825119
...
print(mcr(time, ['F', 'FP', 'P', 'PP'], goodTrajectories, badTrajectories, C4))
